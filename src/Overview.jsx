...
import { ChevronUp, ChevronDown, User, Monitor, Microscope, BriefcaseMedical, Settings, Bell } from 'lucide-react';
            ...
            <main className="container mx-auto p-4 md:p-8">
                ...
                <div className="flex flex-wrap gap-6 mb-6">
                    {summaryCards.map((card, i) => (
                        <div key={i} className="flex-1 bg-[white] p-[9px] rounded-2xl shadow-lg">
