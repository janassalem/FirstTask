            ...
            <div className="p-5 pb-2 w-[1000px] mx-auto  rounded-lg">
                ...
                <div className="overflow-auto max-h-[500px] rounded-[20px]">
                    ...
                    <div className="min-w-[1400px] rounded-[20px] overflow-hidden bg-white ">
                        {/* Table Header  */}
                        <div className="grid grid-cols-[60px_1.5fr_2fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_60px] items-center p-[30px] border-b border-[#e2e2e2] bg-[#f5f5f5] font-normal text-[14px] text-[#333] sticky top-0 z-10 rounded-t-[20px]">
                            <div>
                                <input
                                    type="checkbox"
                        ...
                        <div className="overflow-hidden rounded-b-[20px] max-h-[450px] overflow-y-auto">
                            {filteredData.length > 0 ? (
                                filteredData.map((entry, index) => (
                                    <div
                                        key={index}
                                        className="grid grid-cols-[60px_1.5fr_2fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_60px] items-center p-[20px] border-b border-[#f0f0f0] hover:bg-[#dddddd] transition-colors"
                                    >
                                        <div>
                                            <input
                                                type="checkbox"
